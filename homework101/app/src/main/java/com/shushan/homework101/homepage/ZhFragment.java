...
public class ZhFragment extends BaseFragment {
    ...
    private ArrayList<TeacherBean> teacherBeansZh=new ArrayList<>();
    ...
    private HomepageView homepageView = new HomepageView() {
        ...
        public void onSuccess(Homepage homepage) {
            ...
            if(teacherBeansZh!=null&&teacherBeansZh.size()>0){
                teacherBeansZh.clear();
            }
            if (homepage != null) {
                ...
                if (homepage.getData().getTeacher() != null && homepage.getData().getTeacher().size() > 0) {
                    ...
                    for (int i = 0; i < homepage.getData().getTeacher().size(); i++) {
                        if (homepage.getData().getTeacher().get(i).getSubject().equals(getResources().getString(R.string.my_chinese))) {
                            TeacherBean teacher = new TeacherBean();
                            teacher.setIconUri(homepage.getData().getTeacher().get(i).getTrait());
                            ...
                            teacherBeansZh.add(teacher);
                        }

                    }
                        homepageListViewAdapter = new HomepageListViewAdapter(mContext,teacherBeansZh);

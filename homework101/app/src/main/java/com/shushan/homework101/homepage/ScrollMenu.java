...
public class ScrollMenu extends RelativeLayout {
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            ...
            /*if (-getHeight() == mScroller.getCurrY()) {
                ...
                LogUtils.d("FAST_BOTTOM_TO_NORMAL");
            }*/
            if (-0.3*getHeight() >= mScroller.getCurrY()) {
                mScrollHandler.sendEmptyMessage(ScrollHandler.FAST_BOTTOM_TO_NORMAL);
                LogUtils.d("FAST_BOTTOM_TO_NORMAL");
            }
            /*if (getHeight() == mScroller.getCurrY()) {
                mScrollHandler.sendEmptyMessage(ScrollHandler.FAST_TOP_TO_NORMAL);
                LogUtils.d("FAST_TOP_TO_NORMAL");
            }*/
            if (0.3*getHeight() <=mScroller.getCurrY()) {
                mScrollHandler.sendEmptyMessage(ScrollHandler.FAST_TOP_TO_NORMAL);
                LogUtils.d("FAST_TOP_TO_NORMAL");
    ...
    public void toTop() {
        status = TOP;
        mScroller.startScroll(0, getScrollY(), 0, -getScrollY() + getHeight(), 100);
        invalidate();
    }

    public void toBottom() {
        status = BOTTOM;
        mScroller.startScroll(0, getScrollY(), 0, -(getHeight() + getScrollY()), 100);
        invalidate();
    }

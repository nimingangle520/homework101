...
public class HomeworkGridImageAdapter extends
        RecyclerView.Adapter<HomeworkGridImageAdapter.ViewHolder> {
    ...
    public HomeworkGridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
